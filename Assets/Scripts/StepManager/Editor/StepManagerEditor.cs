...
public class StepManagerEditor : Editor
{
   ...
   public override void OnInspectorGUI()
   {
       ...
       int totalSteps = stepManager.GetTotalStepsDebug();
       ...
       if (totalSteps > 0)
       {
           if (GUILayout.Button("Skip to next step"))
           {
               stepManager.AdvanceStepDebug();
           }
       
           if (GUILayout.Button("Reset Steps"))
           {
               stepManager.ResetStepsDebug();
           }
           ...
           {
               stepManager.JumpToStepDebug(targetStepIndex);
           }
           GUILayout.EndHorizontal();
       }
       else 
