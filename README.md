...
**Drone Assembly Simulator** is a 3D simulation project demonstrating a complete 3-tier cloud architecture. While the frontend provides an interactive VR-ready assembly experience built in Unity, the core of this project showcases automated CI/CD workflows, Infrastructure as Code (IaC), and secure data transmission via a custom REST API.
